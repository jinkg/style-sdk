package com.yalin.wallpaper.blurred_line;
...
import com.yalin.sunlight.GLES20WallpaperService;

import net.rbgrn.android.glwallpaperservice.GLWallpaperService;


public class BlurredWallpaper extends GLES20WallpaperService {
    public static final String SHARED_PREF_NAME = "BlurredLinesSettings";
    private static final boolean DEBUG = false;
    private static String TAG = "Sunlight.BlurredLines";
    private long lastTap = 0;

    public BlurredWallpaper(Context host) {
        super(host);
    }
    ...
    class WallpaperEngine extends GLActiveEngine implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        public WallpaperEngine(Context context, SharedPreferences preferences) {
            ...
            BlurredLinesRenderer renderer = new BlurredLinesRenderer(context);
        ...
        public Bundle onCommand(java.lang.String action, int x, int y, int z,
            ...
            if ((currentTime - lastTap) > 500) {
                ...
                try {
                    myIntent.setClassName(appPackageName, "com.ghisguth.blurredlines.WallpaperSettings");
