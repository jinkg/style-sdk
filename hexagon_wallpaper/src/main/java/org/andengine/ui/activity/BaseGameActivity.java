...
public abstract class BaseGameActivity extends BaseActivity implements IGameInterface, IRendererListener {
	...
	@Override
	public AndEngine onCreateEngine(final EngineOptions pEngineOptions) {
	...
	/**
	 * @see AndEngine#runOnUpdateThread(Runnable)
	 */
	...
	/**
	 * @see AndEngine#runOnUpdateThread(Runnable, boolean)
	 */
	...
	/**
	 * @see {@link AndEngine#enableLocationSensor(Context, ILocationListener, LocationSensorOptions)}
	 */
	...
	/**
	 * @see {@link AndEngine#disableLocationSensor(Context)}
	 */
	...
	/**
	 * @see {@link AndEngine#enableAccelerationSensor(Context, IAccelerationListener)}
	 */
	...
	/**
	 * @see {@link AndEngine#disableAccelerationSensor(Context)}
	 */
	...
	/**
	 * @see {@link AndEngine#enableOrientationSensor(Context, IOrientationListener)}
	 */
	...
	/**
	 * @see {@link AndEngine#disableOrientationSensor(Context)}
	 */
