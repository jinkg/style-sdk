...
public class GLES20WallpaperService extends GLWallpaperServiceProxy {
    private static final boolean DEBUG = false;
    private static String TAG = "Sunlight";

    public GLES20WallpaperService(Context host) {
        super(host);
    }
    ...
    protected static class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
