...
public class DripWallpaperService extends WallpaperServiceProxy {

    final static long STEPS_CHECK_INTERVAL = TimeUnit.MINUTES.toMillis(10);
    //    final static long STEPS_CHECK_INTERVAL = TimeUnit.SECONDS.toMillis(1);
    ...
    private static final int STEPS_GOAL_DEFAULT = 144;
    private static final float LOW_LEVEL_DEFAULT = 0f;
    private static final float TIDE_LEVEL_DEFAULT = 0f;
    ...
    public DripWallpaperService(Context host) {
        super(host);
    ...
    public Engine onCreateEngine() {
        ...
        this.display = ((WindowManager) getApplicationContext()
                .getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay();

        // Tide and low will effect the y offset animation of the wave
        tide = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                TIDE_LEVEL_DEFAULT, getResources().getDisplayMetrics());
        low = -TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                LOW_LEVEL_DEFAULT, getResources().getDisplayMetrics());

        stepsGoal = STEPS_GOAL_DEFAULT;
    ...
    public class DripWallpaperEngine extends Engine implements SensorHelper.OnAngleChangedListener,
            StepsHelper.OnStepsCountFetchedListener {
        ...
        private void draw(Canvas canvas) {
            try {
                ...
                redrawEverything = true;
                canvas.drawColor(ContextCompat.getColor(getApplicationContext(),
        ...
        private void createShader() {
            ...
            c.drawColor(ContextCompat.getColor(getApplicationContext(), R.color.drip_color));
        ...
        private void startListeners() {
            ...
            if (stepsHelper == null) {
                stepsHelper = new StepsHelper(this);
            }
