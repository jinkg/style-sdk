...
public class MatrixWallpaperService extends GLWallpaperServiceProxy {
    Context f2849a = this;

    public MatrixWallpaperService(Context host) {
        super(host);
    }
    ...
    class C0853a extends GLActiveEngine {
        ...
        public C0853a() {
            ...
            settings.layer2 = R.drawable.a01t;
            ...
            this.f2844a = new C0854b(MatrixWallpaperService.this, this.f2845b);
    ...
    public class C0854b extends BroadcastReceiver {
        MyRenderer f2847a;
        final /* synthetic */ MatrixWallpaperService f2848b;

        public C0854b(MatrixWallpaperService myWallpaperService, MyRenderer myRenderer) {
