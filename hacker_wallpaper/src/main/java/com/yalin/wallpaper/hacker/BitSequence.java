...
import com.yalin.wallpaper.hacker.thirdparty.ArrayDeque;
...
public class BitSequence {
    ...
    public static class Style {
        ...
        public static void initParameters(Context context) {
            ...
            color = ContextCompat.getColor(context, R.color.default_bit_color);
            defaultTextSize = context.getResources().getInteger(R.integer.default_text_size);

            double changeBitSpeedMultiplier = 1.0;
            double fallingSpeedMultiplier = 1.0;
     ...
     *
     * @param r the {@link Random} object to use
     ...
     *
     * @param canvas the {@link Canvas} on which to draw the BitSequence
     */
