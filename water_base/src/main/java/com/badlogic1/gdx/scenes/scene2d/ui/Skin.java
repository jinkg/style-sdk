...
package com.badlogic1.gdx.scenes.scene2d.ui;
...
import com.badlogic1.gdx.graphics.g2d.NinePatch;
import com.badlogic1.gdx.graphics.g2d.Sprite;
import com.badlogic1.gdx.graphics.g2d.TextureAtlas;
import com.badlogic1.gdx.graphics.g2d.TextureAtlas.AtlasRegion;
import com.badlogic1.gdx.graphics.g2d.TextureRegion;
import com.badlogic1.gdx.scenes.scene2d.Actor;
import com.badlogic1.gdx.scenes.scene2d.utils.Drawable;
import com.badlogic1.gdx.scenes.scene2d.utils.NinePatchDrawable;
import com.badlogic1.gdx.scenes.scene2d.utils.SpriteDrawable;
import com.badlogic1.gdx.scenes.scene2d.utils.TextureRegionDrawable;
import com.badlogic1.gdx.scenes.scene2d.utils.TiledDrawable;
...
import com.badlogic1.gdx.utils.Json;
import com.badlogic1.gdx.utils.Json.ReadOnlySerializer;
import com.badlogic1.gdx.utils.ObjectMap;
import com.badlogic1.gdx.utils.ObjectMap.Entry;
import com.badlogic1.gdx.utils.SerializationException;
...
public class Skin implements Disposable {
	 ...
	 * and stored in the skin. If the region is an {@link AtlasRegion} then an {@link TextureAtlas.AtlasSprite} is used if the region has been
	...
	public Drawable newDrawable (Drawable drawable, Color tint) {
		if (drawable instanceof TextureRegionDrawable) {
			...
			Sprite sprite;
			if (region instanceof AtlasRegion)
				sprite = new TextureAtlas.AtlasSprite((AtlasRegion)region);
			else
