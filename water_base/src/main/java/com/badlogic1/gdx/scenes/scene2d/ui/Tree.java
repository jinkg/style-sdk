...
import com.badlogic1.gdx.scenes.scene2d.utils.Layout;
 ...
 * <p>
 * {@link ChangeListener.ChangeEvent} is fired when the selected node changes.
 * @author Nathan Sweet */
	...
	private void initialize () {
		addListener(clickListener = new ClickListener() {
			public void clicked (InputEvent event, float x, float y) {
				...
				if (!multiSelect || (!Gdx.input.isKeyPressed(Input.Keys.CONTROL_LEFT) && !Gdx.input.isKeyPressed(Input.Keys.CONTROL_RIGHT))) {
