...
package com.badlogic1.gdx.graphics;

import com.badlogic1.gdx.graphics.glutils.ShaderProgram;

/** A single vertex attribute defined by its {@link VertexAttributes.Usage}, its number of components and its shader alias. The Usage is needed for
...
public final class VertexAttribute {
	/** the attribute {@link VertexAttributes.Usage} **/
	...
	public static VertexAttribute Position () {
		return new VertexAttribute(VertexAttributes.Usage.Position, 3, ShaderProgram.POSITION_ATTRIBUTE);
	}

	public static VertexAttribute TexCoords (int unit) {
		return new VertexAttribute(VertexAttributes.Usage.TextureCoordinates, 2, ShaderProgram.TEXCOORD_ATTRIBUTE + unit);
	}

	public static VertexAttribute Normal () {
		return new VertexAttribute(VertexAttributes.Usage.Normal, 3, ShaderProgram.NORMAL_ATTRIBUTE);
	}

	public static VertexAttribute Color () {
		return new VertexAttribute(VertexAttributes.Usage.ColorPacked, 4, ShaderProgram.COLOR_ATTRIBUTE);
	}

	public static VertexAttribute ColorUnpacked () {
		return new VertexAttribute(VertexAttributes.Usage.Color, 4, ShaderProgram.COLOR_ATTRIBUTE);
	}
