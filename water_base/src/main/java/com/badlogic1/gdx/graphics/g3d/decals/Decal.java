...
public class Decal {
	 ...
	 * @return Created decal */
	// TODO : it would be convenient if {@link Texture} had a getFormat() method to assume transparency
// from RGBA,..
