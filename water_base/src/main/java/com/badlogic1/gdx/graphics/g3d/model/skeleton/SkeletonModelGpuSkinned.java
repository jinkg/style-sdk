...
public class SkeletonModelGpuSkinned extends SkeletonModel {
	...
	private void setupGpuSkin(SkeletonSubMesh subMesh){
		...
		attributeArray[boneIndex] = new VertexAttribute(VertexAttributes.Usage.Generic, 4, BoneIndexAttribue);
		attributeArray[weightIndex] = new VertexAttribute(VertexAttributes.Usage.Generic, 4, BoneWeightAttribue);
