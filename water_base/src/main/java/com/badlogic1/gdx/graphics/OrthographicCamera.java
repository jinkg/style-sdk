...
import com.badlogic1.gdx.math.Vector3Util;
...
public class OrthographicCamera extends Camera {
    ...
    private Vector3 calculateDirection(float angle) {
        ...
        transform.setToRotation(new com.badlogic.gdx.math.Vector3(1, 0, 1).nor(), angle);
    ...
    public void update(boolean updateFrustum) {
        ...
        view.setToLookAt(Vector3Util.switchToBadlogic(position),
                Vector3Util.switchToBadlogic(tmp.set(position).add(direction)),
                Vector3Util.switchToBadlogic(up));
