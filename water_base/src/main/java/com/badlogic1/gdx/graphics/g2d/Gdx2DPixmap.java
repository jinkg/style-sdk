...
public class Gdx2DPixmap implements Disposable {
    ...
    private com.badlogic.gdx.graphics.g2d.Gdx2DPixmap host;
    ...
    public Gdx2DPixmap(byte[] encodedData, int offset, int len, int requestedFormat) throws IOException {
        host = new com.badlogic.gdx.graphics.g2d.Gdx2DPixmap(encodedData, offset, len, requestedFormat);
    ...
    public Gdx2DPixmap(InputStream in, int requestedFormat) throws IOException {
        host = new com.badlogic.gdx.graphics.g2d.Gdx2DPixmap(in, requestedFormat);
    ...
    public Gdx2DPixmap(int width, int height, int format) throws IllegalArgumentException {
        host = new com.badlogic.gdx.graphics.g2d.Gdx2DPixmap(width, height, format);
    ...
    public Gdx2DPixmap(ByteBuffer pixelPtr, long[] nativeData) {
        host = new com.badlogic.gdx.graphics.g2d.Gdx2DPixmap(pixelPtr, nativeData);
