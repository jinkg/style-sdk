...
package com.badlogic1.gdx.graphics.glutils;
...
public class ETC1 {
	...
	/** Encodes the image via the ETC1 compression scheme. Only {@link Pixmap.Format#RGB565} and {@link Pixmap.Format#RGB888} are supported.
	...
	/** Encodes the image via the ETC1 compression scheme. Only {@link Pixmap.Format#RGB565} and {@link Pixmap.Format#RGB888} are supported. Adds
	...
	/** Takes ETC1 compressed image data and converts it to a {@link Pixmap.Format#RGB565} or {@link Pixmap.Format#RGB888} {@link Pixmap}. Does
	 * not modify the ByteBuffer's position or limit.
	 * @param etc1Data the {@link ETC1Data} instance
	 * @param format either {@link Pixmap.Format#RGB565} or {@link Pixmap.Format#RGB888}
	 * @return the Pixmap */
