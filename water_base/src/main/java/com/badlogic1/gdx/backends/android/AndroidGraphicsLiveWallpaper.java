...
import com.badlogic1.gdx.LifecycleListener;
import com.badlogic1.gdx.backends.android.surfaceview.DefaultGLSurfaceViewLW;
import com.badlogic1.gdx.backends.android.surfaceview.GLBaseSurfaceViewLW;
import com.badlogic1.gdx.backends.android.surfaceview.GLSurfaceView20LW;
import com.badlogic1.gdx.backends.android.surfaceview.GdxEglConfigChooser;
import com.badlogic1.gdx.backends.android.surfaceview.ResolutionStrategy;
import com.badlogic1.gdx.graphics.GL10;
import com.badlogic1.gdx.graphics.GL11;
import com.badlogic1.gdx.graphics.GL20;
import com.badlogic1.gdx.graphics.GLCommon;
import com.badlogic1.gdx.graphics.GLU;
import com.badlogic1.gdx.graphics.Mesh;
import com.badlogic1.gdx.graphics.Texture;
import com.badlogic1.gdx.graphics.glutils.FrameBuffer;
import com.badlogic1.gdx.graphics.glutils.ShaderProgram;
import com.badlogic1.gdx.math.WindowedMean;
			...
			if (gl instanceof javax.microedition.khronos.opengles.GL11) {
				...
				if(renderer != null) {
					if (!renderer.toLowerCase().contains("pixelflinger")
						&& !(Build.MODEL.equals("MB200") || Build.MODEL.equals("MB220") || Build.MODEL
							.contains("Behold"))) {
