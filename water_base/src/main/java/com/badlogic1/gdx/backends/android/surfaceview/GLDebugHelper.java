...
package com.badlogic1.gdx.backends.android.surfaceview;
...
public class GLDebugHelper {
	 ...
	 * <p>
	 * Error checking means that the wrapper will automatically call glError after each GL operation, and throw a GLException if an
	 * error occurs. (By design, calling glError itself will not cause an exception to be thrown.) Enabling error checking is an
	 * alternative to manually calling glError after every GL operation.
	 * <p>
