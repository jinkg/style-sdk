...
package com.badlogic1.gdx.utils;
...
public class ScreenUtils {
	 ...
	 * size. The base {@link Texture} always has {@link MathUtils#nextPowerOfTwo} dimensions and RGBA8888 {@link Pixmap.Format}. It can be
	 ...
	 * {@link Pixmap.Format}. It can be accessed via {@link TextureRegion#getTexture}. This texture is not managed and has to be reloaded
	...
	public static TextureRegion getFrameBufferTexture (int x, int y, int w, int h) {
		...
		final Pixmap pixmap = new Pixmap(potW, potH, Pixmap.Format.RGBA8888);
