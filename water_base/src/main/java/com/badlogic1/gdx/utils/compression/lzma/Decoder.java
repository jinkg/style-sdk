...
import com.badlogic1.gdx.utils.compression.lz.OutWindow;
import com.badlogic1.gdx.utils.compression.rangecoder.BitTreeDecoder;
...
public class Decoder {
	class LenDecoder {
		...
		public void Init () {
			com.badlogic1.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_Choice);
		...
		public int Decode (com.badlogic1.gdx.utils.compression.rangecoder.Decoder rangeDecoder, int posState) throws IOException {
	...
	class LiteralDecoder {
		class Decoder2 {
			...
			public void Init () {
				com.badlogic1.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_Decoders);
			}

			public byte DecodeNormal (com.badlogic1.gdx.utils.compression.rangecoder.Decoder rangeDecoder) throws IOException {
				int symbol = 1;
				do
			...
			public byte DecodeWithMatchByte (com.badlogic1.gdx.utils.compression.rangecoder.Decoder rangeDecoder, byte matchByte)
				throws IOException {
				int symbol = 1;
				do {
	...
	com.badlogic1.gdx.utils.compression.rangecoder.Decoder m_RangeDecoder = new com.badlogic1.gdx.utils.compression.rangecoder.Decoder();
	...
	void Init () throws IOException {
		...
		com.badlogic1.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_IsMatchDecoders);
		com.badlogic1.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRep0LongDecoders);
		com.badlogic1.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepDecoders);
		com.badlogic1.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG0Decoders);
		com.badlogic1.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG1Decoders);
		com.badlogic1.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG2Decoders);
		com.badlogic1.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_PosDecoders);
