...
import com.badlogic1.gdx.utils.NumberUtils;
...
public class Sprite extends TextureRegion {
	...
	public void setBounds (float x, float y, float width, float height) {
		...
		vertices[SpriteBatch.X1] = x;
		vertices[SpriteBatch.Y1] = y;

		vertices[SpriteBatch.X2] = x;
		vertices[SpriteBatch.Y2] = y2;

		vertices[SpriteBatch.X3] = x2;
		vertices[SpriteBatch.Y3] = y2;

		vertices[SpriteBatch.X4] = x2;
		vertices[SpriteBatch.Y4] = y;
	...
	public void translateX (float xAmount) {
		...
		float[] vertices = this.vertices;
		vertices[SpriteBatch.X1] += xAmount;
		vertices[SpriteBatch.X2] += xAmount;
		vertices[SpriteBatch.X3] += xAmount;
		vertices[SpriteBatch.X4] += xAmount;
	}
	...
	public void translateY (float yAmount) {
		...
		float[] vertices = this.vertices;
		vertices[SpriteBatch.Y1] += yAmount;
		vertices[SpriteBatch.Y2] += yAmount;
		vertices[SpriteBatch.Y3] += yAmount;
		vertices[SpriteBatch.Y4] += yAmount;
	}
	...
	public void rotate90 (boolean clockwise) {
		...
		if (clockwise) {
			float temp = vertices[SpriteBatch.V1];
			vertices[SpriteBatch.V1] = vertices[SpriteBatch.V4];
			vertices[SpriteBatch.V4] = vertices[SpriteBatch.V3];
			vertices[SpriteBatch.V3] = vertices[SpriteBatch.V2];
			vertices[SpriteBatch.V2] = temp;

			temp = vertices[SpriteBatch.U1];
			vertices[SpriteBatch.U1] = vertices[SpriteBatch.U4];
			vertices[SpriteBatch.U4] = vertices[SpriteBatch.U3];
			vertices[SpriteBatch.U3] = vertices[SpriteBatch.U2];
			vertices[SpriteBatch.U2] = temp;
		} else {
			float temp = vertices[SpriteBatch.V1];
			vertices[SpriteBatch.V1] = vertices[SpriteBatch.V2];
			vertices[SpriteBatch.V2] = vertices[SpriteBatch.V3];
			vertices[SpriteBatch.V3] = vertices[SpriteBatch.V4];
			vertices[SpriteBatch.V4] = temp;

			temp = vertices[SpriteBatch.U1];
			vertices[SpriteBatch.U1] = vertices[SpriteBatch.U2];
			vertices[SpriteBatch.U2] = vertices[SpriteBatch.U3];
			vertices[SpriteBatch.U3] = vertices[SpriteBatch.U4];
			vertices[SpriteBatch.U4] = temp;
		}
	}
	...
	public float[] getVertices () {
		if (dirty) {
			...
			if (rotation != 0) {
				...
				vertices[SpriteBatch.X1] = x1;
				vertices[SpriteBatch.Y1] = y1;
				...
				vertices[SpriteBatch.X4] = x1 + (x3 - x2);
				vertices[SpriteBatch.Y4] = y3 - (y2 - y1);
			} else {
	...
	public Rectangle getBoundingRectangle () {
		...
		float minx = vertices[SpriteBatch.X1];
		float miny = vertices[SpriteBatch.Y1];
		float maxx = vertices[SpriteBatch.X1];
		float maxy = vertices[SpriteBatch.Y1];

		minx = minx > vertices[SpriteBatch.X2] ? vertices[SpriteBatch.X2] : minx;
		minx = minx > vertices[SpriteBatch.X3] ? vertices[SpriteBatch.X3] : minx;
		minx = minx > vertices[SpriteBatch.X4] ? vertices[SpriteBatch.X4] : minx;

		maxx = maxx < vertices[SpriteBatch.X2] ? vertices[SpriteBatch.X2] : maxx;
		maxx = maxx < vertices[SpriteBatch.X3] ? vertices[SpriteBatch.X3] : maxx;
		maxx = maxx < vertices[SpriteBatch.X4] ? vertices[SpriteBatch.X4] : maxx;

		miny = miny > vertices[SpriteBatch.Y2] ? vertices[SpriteBatch.Y2] : miny;
		miny = miny > vertices[SpriteBatch.Y3] ? vertices[SpriteBatch.Y3] : miny;
		miny = miny > vertices[SpriteBatch.Y4] ? vertices[SpriteBatch.Y4] : miny;

		maxy = maxy < vertices[SpriteBatch.Y2] ? vertices[SpriteBatch.Y2] : maxy;
		maxy = maxy < vertices[SpriteBatch.Y3] ? vertices[SpriteBatch.Y3] : maxy;
		maxy = maxy < vertices[SpriteBatch.Y4] ? vertices[SpriteBatch.Y4] : maxy;
	...
	public Color getColor () {
		float floatBits = vertices[SpriteBatch.C1];
		int intBits = NumberUtils.floatToIntColor(vertices[SpriteBatch.C1]);
	...
	public void setRegion (float u, float v, float u2, float v2) {
		...
		vertices[SpriteBatch.U1] = u;
		vertices[SpriteBatch.V1] = v2;

		vertices[SpriteBatch.U2] = u;
		vertices[SpriteBatch.V2] = v;

		vertices[SpriteBatch.U3] = u2;
		vertices[SpriteBatch.V3] = v;

		vertices[SpriteBatch.U4] = u2;
		vertices[SpriteBatch.V4] = v2;
	}
	...
	public void flip (boolean x, boolean y) {
		...
		float[] vertices = Sprite.this.vertices;
		if (x) {
			float temp = vertices[SpriteBatch.U1];
			vertices[SpriteBatch.U1] = vertices[SpriteBatch.U3];
			vertices[SpriteBatch.U3] = temp;
			temp = vertices[SpriteBatch.U2];
			vertices[SpriteBatch.U2] = vertices[SpriteBatch.U4];
			vertices[SpriteBatch.U4] = temp;
		}
		if (y) {
			float temp = vertices[SpriteBatch.V1];
			vertices[SpriteBatch.V1] = vertices[SpriteBatch.V3];
			vertices[SpriteBatch.V3] = temp;
			temp = vertices[SpriteBatch.V2];
			vertices[SpriteBatch.V2] = vertices[SpriteBatch.V4];
			vertices[SpriteBatch.V4] = temp;
		}
	}
	...
	public void scroll (float xAmount, float yAmount) {
		float[] vertices = Sprite.this.vertices;
		if (xAmount != 0) {
			float u = (vertices[SpriteBatch.U1] + xAmount) % 1;
		...
		if (yAmount != 0) {
			float v = (vertices[SpriteBatch.V2] + yAmount) % 1;
