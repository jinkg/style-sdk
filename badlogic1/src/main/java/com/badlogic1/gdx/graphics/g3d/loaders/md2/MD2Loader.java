...
package com.badlogic1.gdx.graphics.g3d.loaders.md2;
...
import com.badlogic1.gdx.utils.LittleEndianInputStream;
...
public class MD2Loader implements KeyframedModelLoader {
	...
	private KeyframedModel buildModel (MD2Header header, MD2Triangle[] triangles, float[] texCoords, MD2Frame[] frames,
		...
		Mesh mesh = new Mesh(Mesh.VertexDataType.VertexArray, false, header.numVertices, indices.length, new VertexAttribute(
			VertexAttributes.Usage.Position, 3, ShaderProgram.POSITION_ATTRIBUTE), new VertexAttribute(VertexAttributes.Usage.Normal, 3,
