...
public class SpriteCache implements Disposable {
	static private final float[] tempVertices = new float[Sprite.VERTEX_SIZE * 6];
	...
	public SpriteCache (int size, ShaderProgram shader, boolean useIndices) {
		...
		mesh = new Mesh(true, size * (useIndices ? 4 : 6), useIndices ? size * 6 : 0, new VertexAttribute(VertexAttributes.Usage.Position, 2,
	...
	public void add (Sprite sprite) {
		...
		System.arraycopy(spriteVertices, 0, tempVertices, 0, 3 * Sprite.VERTEX_SIZE); // temp0,1,2=sprite0,1,2
		System.arraycopy(spriteVertices, 2 * Sprite.VERTEX_SIZE, tempVertices, 3 * Sprite.VERTEX_SIZE, Sprite.VERTEX_SIZE); // temp3=sprite2
		System.arraycopy(spriteVertices, 3 * Sprite.VERTEX_SIZE, tempVertices, 4 * Sprite.VERTEX_SIZE, Sprite.VERTEX_SIZE); // temp4=sprite3
		System.arraycopy(spriteVertices, 0, tempVertices, 5 * Sprite.VERTEX_SIZE, Sprite.VERTEX_SIZE); // temp5=sprite0
