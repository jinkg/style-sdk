...
import com.badlogic1.gdx.graphics.glutils.PixmapTextureData;
...
import com.badlogic1.gdx.utils.OrderedMap;
 ...
 * {@link #generateTextureAtlas(Texture.TextureFilter, Texture.TextureFilter, boolean)} and
 * {@link #updateTextureAtlas(TextureAtlas, Texture.TextureFilter, Texture.TextureFilter, boolean)} need to be called on the rendering thread, all
...
public class PixmapPacker implements Disposable {
	 ...
	 * any {@link TextureAtlas} generated or updated by either {@link #generateTextureAtlas(Texture.TextureFilter, Texture.TextureFilter, boolean)}
	 * or {@link #updateTextureAtlas(TextureAtlas, Texture.TextureFilter, Texture.TextureFilter, boolean)}. Do not call this method if you
	...
	public synchronized void updateTextureAtlas (TextureAtlas atlas, Texture.TextureFilter minFilter, Texture.TextureFilter magFilter,
                                                 boolean useMipMaps) {
		for (Page page : pages) {
