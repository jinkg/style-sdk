...
public class LoadUtil2 {
    public static ModelData m924a(String str, Resources resources, Context context) {
        ...
        try {
                ...
                if (split[0].trim().equals("v")) {
                    ...
                    if (split[0].trim().equals("vt")) {
                        ...
                        if (split[0].trim().equals("f")) {
                            ...
                            parseFloat = arrayList.get((iArr[0] * 3) + 2);
                            arrayList3.add(min);
                            arrayList3.add(max);
                            arrayList3.add(parseFloat);
                            iArr[1] = Integer.parseInt(split[2].split("/")[0]) - 1;
                            min = arrayList.get(iArr[1] * 3);
                            max = arrayList.get((iArr[1] * 3) + 1);
                            parseFloat = arrayList.get((iArr[1] * 3) + 2);
                            arrayList3.add(min);
                            arrayList3.add(max);
                            arrayList3.add(parseFloat);
                            iArr[2] = Integer.parseInt(split[3].split("/")[0]) - 1;
                            min = arrayList.get(iArr[2] * 3);
                            max = arrayList.get((iArr[2] * 3) + 1);
                            parseFloat = arrayList.get((iArr[2] * 3) + 2);
                            arrayList3.add(min);
                            arrayList3.add(max);
                            arrayList3.add(parseFloat);
                            arrayList2.add(iArr[0]);
                            arrayList2.add(iArr[1]);
                            arrayList2.add(iArr[2]);
            ...
            return new ModelData(context, fArr, fArr3, fArr2, new Point((f2 + f) / 2.0f, (f4 + f3) / 2.0f, (f6 + f5) / 2.0f));
        } catch (Exception e) {
