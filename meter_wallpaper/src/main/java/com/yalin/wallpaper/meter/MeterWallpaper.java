...
import com.yalin.wallpaper.meter.drawers.Drawer;
import com.yalin.wallpaper.meter.drawers.WifiDrawer;
 ...
 */
public class MeterWallpaper extends WallpaperServiceProxy {
    ...
    public MeterWallpaper(Context host) {
        super(host);
    }
     ...
     */
    private class WallpaperEngine extends ActiveEngine {
        ...
        public void onVisibilityChanged(boolean visible) {
            ...
            if (visible) {
                ...
                drawerClasses.add(WifiDrawer.class);
